...
export const suratThaniAttractions: Attraction[] = [
  {
    ...
    highlight: "เจดีย์ลอยฟ้า อุทยานธรรมเขานาในหลวง (พนม)",
    image: bhawanathamKhaoNaNaiLuangImg,
    ...
    funnyCaption:
      "ใส่บาตรยังได้บุญ แต่ถ้าใส่ใจคุณ.. ไม่ได้อะไรเลย นอกเหนือจากความสงบ",
    location: "อำเภอพนม",
  },
  {
    id: 2,
    ...
    image: namTokMueangThuatImg,
    details: `น้ำตก 7 ชั้นที่ซ่อนตัวอยู่ในป่าลึก บรรยากาศเงียบสงบเหมือนมีน้ำตกส่วนตัวหลังบ้าน น้ำตกเหมืองทวด ตั้งอยู่ในอุทยานแห่งชาติใต้ร่มเย็น เป็นน้ำตกที่มีความสวยงามและอุดมสมบูรณ์ มีทั้งหมด 7 ชั้น แต่ละชั้นมีความสวยงามแตกต่างกันไป บรรยากาศเงียบสงบ ร่มรื่น เหมาะแก่การพักผ่อนและเล่นน้ำ ช่วงเวลาที่เหมาะสมที่สุดในการท่องเที่ยวคือช่วงปลายฝนต้นหนาว`,
    funnyCaption: "น้ำตกเหมืองทวดอ่ะของจริง แต่ที่เธอทิ้งอ่ะ.. ของปลอม!",
    location: "อำเภอบ้านนาสาร",
  },
  {
    id: 3,
    slug: "nam-tok-dat-fa",
    ...
    funnyCaption:
      "เดินขึ้นน้ำตกดาดฟ้ามันเหนื่อย แต่ถ้าได้เธอเป็นแฟน.. เราหายเหนื่อยทันที",
    location: "อำเภอบ้านนาสาร",
  },
  {
    id: 4,
    ...
    funnyCaption: "น้ำราดอ่ะใส แต่ใจเธอทำไมมันขุ่นจังล่ะเบ๊บ",
    location: "อำเภอคีรีรัฐนิคม",
  },
  {
    id: 5,
    ...
    image: watPhraBorommathatChaiyaImg,
    ...
    funnyCaption: "เข้าวัดอาจจะร้อน แต่ถ้ามาอ้อน.. พี่พร้อมรับนะครับ",
    location: "อำเภอไชยา",
  },
  {
    id: 6,
    ...
    description:
      "ร้านดังระดับตำนานที่สายตื๊ดต้องรู้จัก ดนตรีสดดีมาก บรรยากาศกึ่งผับกึ่งบาร์ เหมาะกับมากับแก๊งเพื่อน",
    ...
    funnyCaption: "กินเหล้ามันทำลายตับ แต่ถ้าเธอไม่รับรักมันทำลายหัวใจ",
